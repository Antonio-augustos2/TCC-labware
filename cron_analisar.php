...
try {
    ...
    // As candidaturas com falha na análise permanecem sem alteração no banco;
    // apenas as que forem concluídas com sucesso devem atualizar o status final.
    ...
    echo json_encode([
        'error' => 'Não foi possível concluir o processamento das análises.',
        'timestamp' => date('Y-m-d H:i:s')
    ]);
}
