  ...
  <section class="hero" id="home">
    <div class="container hero-grid">
      <div class="hero-text">
        ...
        <p>Na LabWare, desenvolvemos soluções tecnológicas que revolucionam a gestão de laboratórios clínicos e de análises.</p>
  ...
  <section id="sobre" class="about">
    <div class="container">
      ...
      <div class="about-content">
        <p>Somos uma empresa especializada em tecnologia para gestão laboratorial. Nossa missão é simplificar processos, garantir qualidade e precisão nos resultados, enquanto desenvolvemos talentos e construímos um ambiente de trabalho colaborativo e inspirador.</p>
        <p>Trabalhamos com laboratórios clínicos, análises químicas e centros de pesquisa, oferecendo soluções completas de software e gestão de dados.</p>
      </div>
    </div>
  </section>
